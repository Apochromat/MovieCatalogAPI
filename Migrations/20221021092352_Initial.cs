    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PosterLink = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieGenresGenreId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    MovieGenresMovieId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreMovie", x => new { x.MovieGenresGenreId, x.MovieGenresMovieId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_GenreMovie_Movies_MovieGenresMovieId",
                        column: x => x.MovieGenresMovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserFavoritesMovieId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    UserFavoritesUserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieUser", x => new { x.UserFavoritesMovieId, x.UserFavoritesUserId });
                    table.ForeignKey(
                        name: "FK_MovieUser_Movies_UserFavoritesMovieId",
                        column: x => x.UserFavoritesMovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieUser_Users_UserFavoritesUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreMovie_MovieGenresMovieId",
                table: "GenreMovie",
                column: "MovieGenresMovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieUser_UserFavoritesUserId",
                table: "MovieUser",
